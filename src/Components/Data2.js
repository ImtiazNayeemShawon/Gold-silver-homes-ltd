...
const rows = [
  createData("Project name ",'silver Anawar ladge'),
  createData("Location",'doctor para ,badur tola ,sadar dakkhin,cumilla'),
  createData("Appartment size",'A=1435sft','B=1230sft','c=1026sft','d=1500sft'),
  createData("Sort summary",'3 bed,3 baths,living,family living,dining,kitchen & 3 verndas'),
  createData("Project type",'residential'),
  createData("Storied/Building height",'Gf to 10th'),
  ...
  createData("lift",'1'),
  createData("Hand over year",'december 2015'),
];
